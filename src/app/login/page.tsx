...
import { isAdmin, isLoggedIn, setToken, setUser } from "@/lib/auth";
    ...
    <div className="relative w-full max-w-sm">
      ...
      <div className="bg-[#0D1220] border border-white/5 p-8">
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          {isVerified && (
            <p className="font-mono text-[10px] text-emerald-400 border border-emerald-400/20 bg-emerald-400/5 px-3 py-2 mb-4">
